...
class DataBlockchain:
    def __init__(self):
        self.data = pd.read_csv('data/blockchain.csv')
...
# Create an instance of the DataBlockchain class
data_blockchain = DataBlockchain()
data_blockchain.process_data()
data_blockchain.analyze_data()
data_blockchain.visualize_data()