...
class DataRobotics:
    def __init__(self):
        self.data = pd.read_csv('data/robotics.csv')
...
# Create an instance of the DataRobotics class
data_robotics = DataRobotics()
data_robotics.process_data()
data_robotics.analyze_data()
data_robotics.visualize_data()