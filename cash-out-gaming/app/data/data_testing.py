...
class DataTesting:
    def __init__(self):
        self.data = pd.read_csv('data/testing.csv')
...
# Create an instance of the DataTesting class
data_testing = DataTesting()
data_testing.process_data()
data_testing.analyze_data()
data_testing.visualize_data()