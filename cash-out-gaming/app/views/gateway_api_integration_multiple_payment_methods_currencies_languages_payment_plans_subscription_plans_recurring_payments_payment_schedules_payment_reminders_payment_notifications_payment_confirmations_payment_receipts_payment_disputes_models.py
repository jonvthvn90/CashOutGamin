...
class StripePaymentGatewayAPIIntegrationMultiplePaymentMethodsCurrenciesLanguagesPaymentPlansSubscriptionPlansRecurringPaymentsPaymentSchedulesPaymentRemindersPaymentNotificationsPaymentConfirmationsPaymentReceiptsPaymentDisputes(models.Model):
    ...
    stripe_payment_schedule_id = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        verbose_name = 'Stripe Payment Gateway API Integration'
        verbose_name_plural = 'Stripe Payment Gateway API Integrations'